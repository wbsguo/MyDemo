package com.example.administrator.myapplication.courview.wallfech;
...
//        paint.setTypeface(App.getInstace().getTypeface());
//        paint.setTypeface(Typeface.createFromAsset(getContext().getAssets(), "fonts/FOT-SeuratProN-DB_1.otf"));
