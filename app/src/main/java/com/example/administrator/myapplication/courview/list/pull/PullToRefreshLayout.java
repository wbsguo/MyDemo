...
public class PullToRefreshLayout extends RelativeLayout
{
	...
	private void changeState(int to)
	{
		...
		case INIT:
			...
			refreshStateTextView.setText(R.string.refresh_release);
			pullView.clearAnimation();
			pullView.setVisibility(View.VISIBLE);
			// 上拉布局初始状态
			loadStateImageView.setVisibility(View.GONE);
			loadStateTextView.setText(R.string.refresh_pull);
			pullUpView.clearAnimation();
		...
		case RELEASE_TO_LOAD:
			// 释放加载状态
			loadStateTextView.setText(R.string.refresh_release);
		...
		case LOADING:
			...
			loadStateTextView.setText(R.string.refresh_footlading);
			break;
		case DONE:
			// 刷新或加载完毕，啥都不做
			break;
